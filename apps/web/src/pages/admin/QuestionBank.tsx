    ...
    <div className="flex-1 w-full max-w-7xl mx-auto px-lg md:px-xl py-xl space-y-xl bg-background font-body-md text-on-surface h-full overflow-y-auto animate-in fade-in duration-300">
      ...
      <div className="flex flex-col gap-md">
        {loading ? (
          ...
          <div className="text-center text-on-surface-variant py-xl bg-surface border border-outline-variant rounded-lg">
            <p className="font-headline-sm">No questions available.</p>
            <p className="text-sm mt-1">Import or create a new question to populate the bank.</p>
          </div>
        ) : (
          questions.map((q, idx) => {
