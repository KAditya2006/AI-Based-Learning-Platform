...
export const VerifyEmail = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await authApi.verifyEmail({ email, otp: token }) as any;
      ...
      if (authToken && user) {
        ...
        setIsAnalyzing(true);
        try {
          await fetchClient('/ai/learner/competency-insights');
        } catch (e) {
        ...
        <CardContent>
          ...
          <form onSubmit={handleSubmit} className="space-y-md">
            ...
            >
              ...
              {isAnalyzing ? 'Running AI Profile Analysis...' : (isLoading ? 'Verifying...' : 'Verify Email')}
